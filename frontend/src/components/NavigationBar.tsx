import { Search, ScanBarcode, LogOut, UserCircle, LayoutDashboard } from "lucide-react";
...
export function NavigationBar({ onSearchChange, onScanClick, onProfileClick, onDashboardClick, currentUser, currentUserName, currentUserRole, onLogout }: NavigationBarProps) {
            ...
            <div className="flex items-center gap-2">
              {currentUserRole === "admin" && (
                <button onClick={onDashboardClick}
                  className="flex items-center gap-1 rounded-full border border-purple-200 bg-purple-50 px-3 py-1.5 text-xs font-medium text-purple-700 transition hover:bg-purple-100">
